...
def stitchWithFeature():
    ...
    Stitcher.roiRatio = 1                       # roi length for stitching in first direction
    ...
    projectAddress = "./wuyan-sem/"
    outputAddress = "result/wuyan-sem-" + str.capitalize(Stitcher.fuseMethod) + "/"
    stitcher.imageSetStitchWithMutiple(projectAddress, outputAddress, 2, stitcher.calculateOffsetForFeatureSearchIncre,
                            startNum=1, fileExtension="tif", outputfileExtension="jpg")
